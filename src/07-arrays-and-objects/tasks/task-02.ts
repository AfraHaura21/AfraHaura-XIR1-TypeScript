...
// Available Products
const availableProduct = products.filter(product => product.stock > 0);
...
//  Sort available products from most expensive → cheapest
const sortedProducts = [...availableProduct].sort(
    (a, b) => b.price - a.price
);
